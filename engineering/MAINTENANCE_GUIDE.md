...
Read `engineering/ARCHITECTURE.md` and `engineering/CODING_GUIDELINES.md` before changing code. Use `engineering/INDEX.md` when a task touches a specific screen or workflow.
