...
- If a confirmed defect requires observable change, record the old behavior, reason, new behavior, and impact in `engineering/REFACTORING_NOTES.md`.
...
- engineering/developer guidance belongs under `engineering/`; do not place agent instructions in production or customer-documentation folders.
